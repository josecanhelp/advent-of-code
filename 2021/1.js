...
popAndCheck(entries);
// const a = entries.map((e) => {
    // const otherEntries = entries.filter((n) => n !== e);
    // if (otherEntries.some((x) => x + e === 2020)) {
        // return otherEntries.find((x) => x + e === 2020);
    // }
// })
    // .filter(n => !!n)
...
// const b = [
    // ...new Set(
        // entries.map((e) => {
            // const otherEntries = entries.filter((n) => n !== e);
            // const d = otherEntries.map((f) => {
                // const otherOtherEntries = entries.filter((m) => m !== e && m !== f);
                // if (otherOtherEntries.some((x) => x + f + e === 2020)) {
                    // return otherOtherEntries.find((x) => x + f + e === 2020);
                // }
            // }).filter(n => !!n);
